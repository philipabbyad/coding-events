...
public class EventController {
    ...
    @GetMapping
    // By default, required for param is 'true' unless set otherwise
    public String displayAllEvents(@RequestParam(required = false) Integer categoryId, Model model) {
        ...
        if (categoryId == null) {
            ...
            // will return an eventcategory IFF there is a corresponding categoryId found in the database, otherwise remains empty
